  ...
  connectionPool.getConnection((err, connection) => {
    ...
    connection.query(
      `
        ...
        select temp2.paper_id, paper.title, paper.venue,emerging_author_names, paper.citation_count, paper.pub_date from temp2 join paper on temp2.paper_id = paper.paper_id where temp2.paper_id in (select temp2.paper_id paper_id from temp1 join temp2 on temp1.paper_id = temp2.paper_id
